...
"""
The sonic ipv6_neighbors fact class
...
class Ipv6_neighborsFacts(object):
    """ The sonic ipv6_neighbors fact class
    """

    def __init__(self, module, subspec='config', options='options'):
        self._module = module
        self.argument_spec = Ipv6_neighborsArgs.argument_spec
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        """ Populate the facts for ipv6_neighbors
        ...
        ansible_facts['ansible_network_resources'].pop('ipv6_neighbors', None)
        facts = {}
        if objs:
            params = utils.validate_config(self.argument_spec, {'config': objs})
            facts['ipv6_neighbors'] = params['config']
